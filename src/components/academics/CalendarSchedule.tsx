...
// The academic term structure (accordion). Shown on the calendar page when no
// school-calendar PDF has been published; the flipbook replaces it otherwise.
export async function CalendarTermsSection() {
...
// The school-community events across the year. Always shown on the calendar
// page, whether or not a calendar PDF exists.
export async function CalendarEventsSection() {
  const calendarEvents = await getPublishedEvents();
